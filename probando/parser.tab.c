...
static const char *const yytname[] =
{
  ...
  "INT", "FLOAT", "EQ", "$accept", "program", "statements", "statement",
...
#line 1130 "parser.tab.c"
  ...
  case 9: /* assignment: ID EQ STRING  */
#line 95 "parser.y"
